...
// syntax
//  declare arrayVariable = arrayBeingFiltered.filterMethod(arrowFunction)
...
//  declare function = array.CallbackParameterMethod(function(elem){return equation})
//  map: does not modify the original array, returns copy of original array with changes applied by callback

//NOTE
//  elem is a variable for a callback function
...
//reduce: returns single value, can take 4 arguments (accumulator and current value, index, array)
//accumulator is value that will be returned -- we can set intial value of the accumulator if not will default to first value

// CODE HERE
//  arrow function
// const popSum = populations.reduce((a, c) => a + c)
